...
class LamaFP16InpaintingService {
  static const String _modelAssetPath =
      'assets/models/lama_storage_fp16.onnx';
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      final modelFile = File("${tmp.path}/lama_fp16.onnx");
      ...
      _isInitialized = true;
      debugPrint("LamaFP16InpaintingService -> Initialized");
    } catch (e) {
      debugPrint("LamaFP16 init ERROR: $e");
      rethrow;
    }
  }
  ...
  Future<Uint8List?> inpaint(File imageFile, Uint8List maskBytes) async {
    ...
    try {
      ...
      double maxVal = 0.0;
      // Check a few pixels to guess range
      for(int i=0; i<100; i+=10) {
         maxVal = math.max(maxVal, (rChan[i][i] as num).toDouble());
      }
      bool is0to255 = maxVal > 1.0;
      debugPrint("LamaFP16 Output Max (est): $maxVal, is0to255: $is0to255");
      ...
      // Release tensors AFTER reading data
      outTensor.release();
